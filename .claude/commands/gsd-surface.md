...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/test1/.claude/.gsd-surface.json`
(sibling to `/home/user/test1/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/test1/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/test1/.claude/skills`).
...
`/home/user/test1/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/test1/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/test1/.claude/.gsd-surface.json`
Install profile marker: `/home/user/test1/.claude/.gsd-profile`
Skill dirs: `/home/user/test1/.claude/skills/gsd-*/`
Engine module: `/home/user/test1/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/test1/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
