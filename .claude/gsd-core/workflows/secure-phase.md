...
```
Agent(
  prompt="Read /home/user/test1/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/test1/.claude/gsd-core/templates/SECURITY.md`
