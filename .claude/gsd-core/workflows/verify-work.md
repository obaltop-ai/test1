...
<template>
@/home/user/test1/.claude/gsd-core/templates/UAT.md
</template>
...
Read and follow `/home/user/test1/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/user/test1/.claude/gsd-core/workflows/diagnose-issues.md
