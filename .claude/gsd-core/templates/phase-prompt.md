...
<!-- For checkpoint task examples and patterns, see @/home/user/test1/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/test1/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/test1/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/user/test1/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
