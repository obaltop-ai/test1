...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/test1/.claude
                  → checks /home/user/test1/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/test1/.claude/gsd-core
                  → writes to /home/user/test1/.claude/gsd-core/hooks/
